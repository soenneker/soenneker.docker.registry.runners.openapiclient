...
using Soenneker.Docker.Registry.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Docker.Registry.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Registry:ClientGenerationUrl"] ?? "https://docs.docker.com/reference/api/registry/latest.yaml";
        ...
        if (filePath == null)
            throw new InvalidOperationException("Registry OpenAPI document download failed.");
        ...
        await _kiotaUtil.Generate(fixedFilePath, "DockerRegistryOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
